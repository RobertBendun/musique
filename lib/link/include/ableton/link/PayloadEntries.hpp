...
#include <cmath>
#include <cstdint>
#include <ableton/mbliterals.hpp>
...
struct HostTime
{
  static const std::int32_t key = ableton::bytes("__ht");
...
struct GHostTime
{
  static const std::int32_t key = ableton::bytes("__gt");
...
{
  static const std::int32_t key = ableton::bytes("_pgt");
